...
{
    [DbContext(typeof(InternshipJournalDbContext))]
    [Migration("20260825150243_Added_MentorReview_Module")]
    partial class Added_MentorReview_Module
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InternshipJournal.DailyLogs.DailyLog", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("InternProfileId", "LogDate")
                        .IsUnique();

                    b.ToTable("AppDailyLogs", (string)null);
                });

            modelBuilder.Entity("InternshipJournal.DailyLogs.DailyLogItem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppDailyLogItems", (string)null);
                });

            modelBuilder.Entity("InternshipJournal.DailyLogs.DailyLogSkill", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("DailyLogId", "SkillId")
                        .IsUnique();

                    b.ToTable("AppDailyLogSkills", (string)null);
                });

            modelBuilder.Entity("InternshipJournal.DailyLogs.ProblemSolvingEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");

                    b.Property<string>("AiPromptSummary")
                        .HasMaxLength(1000)
                        .HasColumnType("character varying(1000)");
                    ...
                    b.Property<bool?>("AiSuggestionAccepted")
                        .HasColumnType("boolean");
                    ...
                    b.Property<bool>("UsedArtificialIntelligence")
                        .HasColumnType("boolean");
                    ...
                    b.ToTable("AppProblemSolvingEntries", (string)null);
                });

            modelBuilder.Entity("InternshipJournal.InternProfiles.InternProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppInternProfiles", (string)null);
                });

            modelBuilder.Entity("InternshipJournal.Locations.Country", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("InternshipJournal.Locations.District", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("InternshipJournal.Locations.Province", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("InternshipJournal.MentorReviews.MentorReview", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppMentorReviews", (string)null);
                });

            modelBuilder.Entity("InternshipJournal.Skills.Skill", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("InternshipJournal.Workplaces.Workplace", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppWorkplaces", (string)null);
                });
            ...
            modelBuilder.Entity("InternshipJournal.DailyLogs.DailyLog", b =>
                {
                    b.HasOne("InternshipJournal.InternProfiles.InternProfile", null)
                        .WithMany()
            ...
            modelBuilder.Entity("InternshipJournal.DailyLogs.DailyLogItem", b =>
                {
                    b.HasOne("InternshipJournal.DailyLogs.DailyLog", null)
                        .WithMany("Items")
            ...
            modelBuilder.Entity("InternshipJournal.DailyLogs.DailyLogSkill", b =>
                {
                    ...
                    b.HasOne("InternshipJournal.Skills.Skill", null)
                        .WithMany()
            ...
            modelBuilder.Entity("InternshipJournal.InternProfiles.InternProfile", b =>
                {
                    b.HasOne("InternshipJournal.Workplaces.Workplace", null)
                        .WithMany()
                        .HasForeignKey("WorkplaceId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.OwnsOne("InternshipJournal.InternProfiles.DateRange", "InternshipPeriod", b1 =>
                        {
                            b1.Property<Guid>("InternProfileId")
                                .HasColumnType("uuid");

                            b1.Property<DateTime>("EndDate")
                                .HasColumnType("timestamp without time zone")
                                .HasColumnName("InternshipPeriod_EndDate");

                            b1.Property<DateTime>("StartDate")
                                .HasColumnType("timestamp without time zone")
                                .HasColumnName("InternshipPeriod_StartDate");

                            b1.HasKey("InternProfileId");

                            b1.ToTable("AppInternProfiles");
            ...
            modelBuilder.Entity("InternshipJournal.Locations.District", b =>
                {
                    b.HasOne("InternshipJournal.Locations.Province", null)
                        .WithMany()
            ...
            modelBuilder.Entity("InternshipJournal.Locations.Province", b =>
                {
                    b.HasOne("InternshipJournal.Locations.Country", null)
                        .WithMany()
            ...
            modelBuilder.Entity("InternshipJournal.Workplaces.Workplace", b =>
                {
                    b.HasOne("InternshipJournal.Locations.District", null)
                        .WithMany()
