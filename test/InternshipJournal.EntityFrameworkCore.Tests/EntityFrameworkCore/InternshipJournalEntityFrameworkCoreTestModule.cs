...
public class InternshipJournalEntityFrameworkCoreTestModule : AbpModule
{
    ...
    private void ConfigureInMemorySqlite(IServiceCollection services)
    {
        ...
        _database.CreateTables(
            new InternshipJournalDbContext(new DbContextOptionsBuilder<InternshipJournalDbContext>().UseSqlite(_database.ConnectionString).Options));
